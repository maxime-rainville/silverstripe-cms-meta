...
import installer411x from './release-set/silverstripe/installer/4.11.x-dev.json';
...
import sink411x from './release-set/silverstripe/recipe-kitchen-sink/4.11.x-dev.json';
...
const releases: {readonly [release: string]: ReleaseLine} = {
  ...
  'Silverstripe CMS 4.11.x': installer411x,
  ...
  'Silverstripe Sink 4.11.x': sink411x,
